...
This check can be performed once your SDL app has left the HMI state of `NONE`. More information on how to monitor the HMI status can be found in the [Understanding Permissions](Getting Started/Understanding Permissions#monitoring-the-hmi-level) guide.
!@
