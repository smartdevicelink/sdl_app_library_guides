...
| Vehicle Data | Parameter Name  |  Description | Deprecated |
| ------------- | ------------- | ------------- | ------------- |
...
| Fuel Range | fuelRange | The estimate range in KM the vehicle can travel based on fuel level and consumption. As of RPC 7.0, this also contains Fuel Level and Fuel Level State information. ||
| Gear Status | gearStatus | Includes information about the transmission, the user's selected gear, and the actual gear of the vehicle.  ||
