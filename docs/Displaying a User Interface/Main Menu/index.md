...
## Adding Submenus
Adding a submenu is as simple as adding subcells to a `MenuCell`. This can currently only be done with one layer of subcells, and automatically displays the submenu when selected.
