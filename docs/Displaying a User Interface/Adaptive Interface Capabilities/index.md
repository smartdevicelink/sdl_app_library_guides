...
| @![iOS]prerecordedSpeechCapabilities!@ @![android, javaSE, javaEE]SystemCapabilityType.PRERECORDED_SPEECH!@ | A list of pre-recorded sounds you can use in your app. Sounds may include a help, initial, listen, positive, or a negative jingle. | @![iOS]Check SDLPrerecordedSpeech.h for more information!@ @![android, javaSE, javaEE]Check PrerecordedSpeech.java  for more information!@ |
