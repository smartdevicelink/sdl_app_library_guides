...
| @![iOS]audioPassThruCapabilities!@@![android, javaSE, javaE, javascript]SystemCapabilityType.AUDIO_PASSTHROUGH!@ | Describes the sampling rate, bits per sample, and audio types available. |
