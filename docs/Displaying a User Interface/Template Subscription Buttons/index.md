...
If desired, you can toggle the play/pause button image between a play, stop, or pause icon by updating the audio streaming state, you can also set the style of play/pause button and the next/previous buttons in the [Media Clock](Displaying a User Interface/Media Clock) guide. 
