...
* [Foreground Service ](https://developer.android.com/reference/android/Manifest.permission.html#FOREGROUND_SERVICE) - Required to run services in the foreground for applications targeting Android P (API Level 28) or higher
