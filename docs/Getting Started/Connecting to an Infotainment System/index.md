...
!!! IMPORTANT
Known issues with using a TCP connection:

* When your app on the phone is the background, the SDL app will be unable to communicate with SDL Core. This will work with IAP connections.
...
* You cannot connect to an emulator using a USB cord or Bluetooth (i.e. an IAP connection) due to Apple restrictions on IAP connections.
!!!
