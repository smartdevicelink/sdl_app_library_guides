...
### Examples
To compile release 5.3.0, use the following line:

```
dependencies {
    implementation 'com.smartdevicelink:sdl_android:5.3.0'
}
```
...
```
dependencies {
    implementation 'com.smartdevicelink:sdl_java_se:5.3.0'
}
```
